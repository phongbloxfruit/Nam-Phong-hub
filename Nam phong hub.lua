...
v0.new("<Color=Cyan>chao mung den voi dia nguc<Color=/>"):Display();
wait(0.5);
...
v5.Window = function(v134, v135)
	...
	v170.Image = "http://www.roblox.com/asset/?id="   .. tostring(11486398809) ;
...
v8.Image = "rbxassetid://11486398809";
v8.Draggable = true;
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	Title = "nam phong adr",
	Text = "Loading...",
	Icon = "rbxthumb://type=Asset&id=11486398809&w=150&h=150",
	Duration = 10
});
spawn(function()
	while wait() do
